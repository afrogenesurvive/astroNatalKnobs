...
class Knob4 extends Component {
  ...
  state = {
    ...
    planetInterpArray: [
      ...
      {planet: 'sun', words: ['ᴀᴛᴛɪᴛᴜᴅᴇ ᴛᴏ ʟɪғᴇ', 'ᴀᴜᴛʜᴏʀɪᴛʏ', 'ᴄᴏɴғɪᴅᴇɴᴄᴇ', 'ᴄᴏɴsᴄɪᴏᴜsɴᴇss', 'ᴄʀᴇᴀᴛɪᴠᴇ ᴇɴᴇʀɢʏ', 'ᴄʀᴇᴀᴛɪᴠᴇ sᴇʟғ-ᴇxᴘʀᴇssɪᴏɴ', 'ᴄʀᴇᴀᴛɪᴠᴇ ᴘᴏᴛᴇɴᴛɪᴀʟ', 'ᴄʀᴇᴀᴛɪᴠɪᴛʏ', 'ᴇɢᴏ', 'ғᴀᴛʜᴇʀ', 'ɢᴏʟᴅ', 'ʜᴇᴀʀᴛ', 'ʜᴏᴘᴇ', 'ɪɴᴅɪᴠɪᴅᴜᴀʟɪᴛʏ', 'ʟɪғᴇ ғᴏʀᴄᴇ', 'ᴍᴀʟᴇ ʀᴏʟᴇ ᴍᴏᴅᴇʟs', 'ᴍᴀsᴄᴜʟɪɴᴇ sɪᴅᴇ ᴏғ sᴇʟғ', 'ᴍᴇᴅɪᴀᴛᴏʀ ʙᴇᴛᴡᴇᴇɴ ɪɴɴᴇʀ sᴇʟғ ᴀɴᴅ ᴏᴜᴛsɪᴅᴇ ᴡᴏʀʟᴅ', 'ᴘᴇʀsᴏɴᴀʟ ɪᴅᴇɴᴛɪᴛʏ', 'ᴘʜʏsɪᴄᴀʟ ᴠɪᴛᴀʟɪᴛʏ', 'ᴘᴏᴛᴇɴᴛɪᴀʟ', 'ᴘᴏᴡᴇʀ', 'ʀᴇᴄᴏɢɴɪᴛɪᴏɴ', 'sᴇʟғ-ᴇxᴘʀᴇssɪᴏɴ', 'sᴇʟғ-ɪɴᴛᴇɢʀᴀᴛɪᴏɴ', 'sᴇɴsᴇ ᴏғ sᴇʟғ', 'ᴠɪᴛᴀʟɪᴛʏ', 'ᴡᴇʟʟ-ʙᴇɪɴɢ'] },
